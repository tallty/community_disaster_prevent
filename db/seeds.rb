...
Diymenu.create(id: 11, parent_id: 2, name: '个人中心', url: 'http://weixin.lightning.sh.cn/oauths?reurl=http://weixin.lightning.sh.cn/communities/centre', is_show: true, sort:2)
